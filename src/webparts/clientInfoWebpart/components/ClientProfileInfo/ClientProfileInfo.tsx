...
const ClientProfileInfo = ({spContext, isClientProfileInfoModalOpen, onClientProfileInfoModalHide, showHideAlertIcon, showHideToast, isDontRemind}): React.ReactElement => {
  ...
  const [sectors, setSectors] = useState<IServices[]>([
    { text: "Acquisitions and Divestitures", checked: false },
    { text: "Affordable Housing", checked: false },
    { text: "Business Management and Outsourcing", checked: false },
    { text: "Cannabis", checked: false },
    { text: "Capital Markets", checked: false },
    { text: "Commercial Real Estate", checked: false },
    { text: "Construction", checked: false },
    { text: "Cyber and Privacy", checked: false },
    { text: "Family Offices", checked: false },
    ...
    { text: "Government - Program Management", checked: false },
    ...
    { text: "RDR", checked: false },
    { text: "Hospitality", checked: false },
    { text: "Life Sciences", checked: false },
    { text: "Manufacturing and Distribution", checked: false },
    { text: "New Markets Tax Credit", checked: false },
  ...
  const [otherInterests, setOtherInterests] = useState<IServices[]>([
    ...
    { text: "ESG", checked: false },
    { text: "Executive Women's Forum Events", checked: false },
    { text: "Future of Work", checked: false },
    { text: "Infrastructure", checked: false },
    { text: "Performance Improvement", checked: false },
    { text: "Tax Credits & Investments", checked: false },
    { text: "Tax Strategies and Planning", checked: false },
